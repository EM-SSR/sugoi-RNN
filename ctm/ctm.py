...
from ctm.modules import ParityBackbone, SynapseUNET, Squeeze, SuperLinear, LearnableFourierPositionalEncoding, MultiLearnableFourierPositionalEncoding, CustomRotationalEmbedding, CustomRotationalEmbedding1D, ShallowWide
from ctm.resnet import prepare_resnet_backbone
...
class ContinuousThoughtMachine(nn.Module):
    ...
    def forward(self, x, teacher=None, track=False):
        B = x.size(0)
        device = x.device
